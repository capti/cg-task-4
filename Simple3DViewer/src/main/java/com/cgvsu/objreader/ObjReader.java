...
public class ObjReader {
	...
	protected static void format(ArrayList<Polygon> polygons, int lengthVertex, int lengthTextureVertex, int lengthNormal) {
		...
		for (Polygon pol: polygons) {
			ArrayList<Integer> vertexIndices = (ArrayList<Integer>) pol.getVertexIndices();
			ArrayList<Integer> textureVertexIndices = (ArrayList<Integer>) pol.getTextureVertexIndices();
			ArrayList<Integer> normalIndices = (ArrayList<Integer>) pol.getNormalIndices();
